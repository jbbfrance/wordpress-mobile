		...
		<div class="uniPricing <?php if ( 'on' !== $calendarius_int_enable || ! isset($aPostCustom['uni_plans_cal_id'][0]) ) { echo "uniPricingCobot"; } ?>">
            ...
            ?>
                <div class="uniPricingItem uni-clear">
                    <div class="fcell">
                        <?php echo wp_kses_post( $plan_thumb ); ?>
                    </div>
                    <div class="scell">
                        <h3><?php the_title() ?></h3>
                        ...
                        <?php if ( has_excerpt( get_the_ID() ) ) { the_excerpt(); } else { uni_coworking_theme_excerpt(100, '', true); } ?>
                        <?php if ( isset($aPostCustom['uni_plan_tax_info_enable'][0]) && $aPostCustom['uni_plan_tax_info_enable'][0] === 'on'
                                && isset($aPostCustom['uni_plan_tax_info_text'][0]) ) { ?>
                        ...
                        <?php } else { ?>
                        <a class="uniPricingItemLink js-price-form-link" data-remodal-target="priceForm" href="#" data-priceid="<?php echo esc_attr( get_the_ID() ); ?>" data-pricetitle="<?php echo esc_attr( get_the_title( get_the_ID() ) ) ?>">
                        <?php } ?>
