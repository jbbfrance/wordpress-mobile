					...
					<div class="singleEventDetails uni-clear">
						<div class="fcell">
							<div class="eventDetailItem">
                                ...
                                <?php } else { echo '<p>'.esc_html__('- not specified -', 'coworking').'</p>'; } ?>
							</div>
							<div class="eventDetailItem">
								<i class="fa fa-clock-o"></i>
								<p><?php if ( !empty($aCustomData['uni_event_time_start'][0]) ) { echo date_i18n($sTimeFormat, strtotime($aCustomData['uni_event_time_start'][0])) . ( (!empty($aCustomData['uni_event_time_end'][0])) ? ' - '.date_i18n($sTimeFormat, strtotime($aCustomData['uni_event_time_end'][0])) : '' ); } else { esc_html_e('- not specified -', 'coworking'); } ?></p>
							</div>
							<div class="eventDetailItem">
								<i class="fa fa-map-marker"></i>
								<p><?php if ( !empty($aCustomData['uni_event_address'][0]) ) { echo esc_html( $aCustomData['uni_event_address'][0] ); } else { esc_html_e('- not specified -', 'coworking'); } ?></p>
							</div>
							<div class="eventDetailItem">
								<i class="fa fa-credit-card"></i>
								<p><?php if ( !empty($aCustomData['uni_event_price'][0]) ) { echo esc_html( $aCustomData['uni_event_price'][0] ); } else { esc_html_e('- not specified -', 'coworking'); } ?></p>
							</div>
						</div>
						<div class="scell">
							<!-- Map -->
	...
	<div data-remodal-id="eventRegistrationPopup" class="eventRegistrationWrap">
		...
		<div class="remodalFormWrap uni-clear">
			...
			<form action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" class="eventRegistrationForm uni-clear uni_form">
				...
				<p><?php esc_html_e('Join our  event. Please fill out the form and our manager will get back asap.', 'coworking'); ?></p>
				<div class="inputWrap">
					<input type="text" name="uni_contact_firstname" value="" placeholder="<?php esc_html_e('First Name', 'coworking') ?>" data-parsley-required="true" data-parsley-trigger="change focusout submit">
				</div>
				<div class="inputWrap">
					<input type="text" name="uni_contact_lastname" value="" placeholder="<?php esc_html_e('Last Name', 'coworking') ?>" data-parsley-required="true" data-parsley-trigger="change focusout submit">
				</div>
				<div class="inputWrap">
				...
				<div class="textareaWrap">
					<textarea name="uni_contact_msg" cols="30" rows="10" placeholder="<?php esc_html_e('Message', 'coworking') ?>" data-parsley-required="true" data-parsley-trigger="change focusout submit"></textarea>
				</div>
                ...
                <?php } ?>
				<input class="thmSubmitBtn uni_input_submit" type="button" value="<?php esc_html_e('Send', 'coworking') ?>">
			</form>
		</div>
	</div>
<?php } ?>
