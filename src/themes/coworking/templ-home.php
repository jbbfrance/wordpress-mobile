...
?>
	...
	<section class="uni-container">
        ...
        ?>
		<div id="Mission" class="secondScreen" data-speed="6" data-type="parallax" style="background-image: url(<?php echo esc_url($sParallaxOneBgUrl) ?>);">
			<div class="overlayBox" style="background: <?php echo esc_attr( ot_get_option('uni_home_parallax_one_overlay') ); ?>"></div>
            <?php
            $sParallaxOneText = ot_get_option('uni_home_parallax_one_text');
            ?>
			<h3><?php if ( !empty($sParallaxOneText) ) { echo wp_kses( $sParallaxOneText, $aUniAllowedHtmlWoA ); } else { esc_html_e('Coworking will help you find the right people', 'coworking'); } ?></h3>
		</div>
        <?php } ?>
                ...
                ?>
    				<div class="pricingPlanItem">
    					...
    					<div class="planPrice">
                            ...
                            </strong>/<?php if ( !empty($aPostCustom['uni_price_period'][0]) ) { echo esc_html($aPostCustom['uni_price_period'][0]); } ?>
        ...
        ?>
                <li style="background-image: url(<?php  echo esc_url( $sEventBgUrl ); ?>);"><div class="eventSlideOverlay"></div></li>
        <?php
                } else {
        ?>
                <li style="background-image: url(http://placehold.it/1920x600/);"><div class="eventSlideOverlay"></div></li>
        <?php
                }
            endwhile;
        endif;
        ?>
            ...
            <div class="eventsContentWrap">
                ...
                <?php if ( ot_get_option('uni_home_events_tickera_enable') != 'on' ) { ?>
                    ...
                    ?>
                    <div data-slide-id="<?php echo esc_attr($iEventCount); ?>" class="eventItem eventItemSimply">
                        <div class="eventTime">
                            <strong><?php
                ...
                <a href="<?php if ( ot_get_option( 'uni_home_events_archive_page' ) ) echo esc_url( get_permalink( ot_get_option( 'uni_home_events_archive_page' ) ) ); ?>" class="allEventsBtn"><?php echo ( ot_get_option( 'uni_home_events_archive_page_link_text' ) ) ? esc_html( ot_get_option( 'uni_home_events_archive_page_link_text' ) ) : esc_html_e('See all events', 'coworking'); ?></a>
            </div>
		</div>
        <?php } ?>
		...
		<div id="Contact" class="homeContact uni-clear">
			...
			<div class="contactInfo">
				<div class="contactInfoDesc js-uni-animated">
                    ...
                    ?>
					<p><?php esc_html_e('Phone', 'coworking'); ?>: <br> <?php echo wp_kses( $sHomeContactPhone, $aUniAllowedHtmlWoA ); ?></p>
                    <?php } ?>
		...
		<div class="subscribeBox">
			...
			<form action="<?php echo admin_url( 'admin-ajax.php' ); ?>" method="post" class="uni_form">
                <input type="hidden" name="action" value="uni_coworking_theme_mailchimp_subscribe_user" />
				<input class="subscribeInput" type="text" name="uni_input_email" size="20" value="" placeholder="<?php esc_html_e('Email', 'coworking' ); ?>" data-parsley-required="true" data-parsley-trigger="change focusout submit" data-parsley-type="email">
				<input class="subscribeBtn uni_input_submit" type="button" value="<?php esc_html_e('subscribe', 'coworking' ); ?>">
			</form>
		</div>
        <?php } ?>
