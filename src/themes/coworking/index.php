...
<!--        <h1 class="blockTitle">--><?php //bloginfo( 'name' ); ?><!--</h1>-->
        <?php if ( get_bloginfo( 'description' ) ) { ?> <div class="archive-desc"><p>  <?php echo esc_html( get_bloginfo( 'description' ) ); ?> </p></div> <?php } ?>
...
<!--        <h1 class="blockTitle"><?php /*bloginfo( 'name' ); */?></h1>-->
        <?php if ( get_bloginfo( 'description' ) ) { ?> <div class="archive-desc"><p>  <?php echo get_bloginfo( 'description' ); ?> </p></div> <?php } ?>
        ...
        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
			<div id="post-<?php the_ID(); ?>" <?php post_class('postItem') ?>>
                ...
                <?php } elseif ( !has_post_thumbnail() && class_exists('Coworking_Plugin') ) { ?>
                    <a href="<?php the_permalink() ?>" class="postItemImg">
				        <img src="http://placehold.it/370x250/5FC7AE/FFFFFF" alt="<?php the_title_attribute() ?>" width="370" height="250">
                    </a>
                <?php } ?>
