            ...
            <div class="wrapper uni-clear">
                <div class="uni-fcell">
                    ...
                    <div class="singlePostWrap uni-clear">
                        <p><?php echo wp_kses_post( $top_image ); ?></p>
                        <div class="alignleft">
                           <?php echo wp_kses_post( $lb_image ); ?>
                        </div>
                        <div class="alignright">
                           <?php echo wp_kses_post( $rb_image ); ?>
                        </div>
                    </div>
                </div>
                <div class="uni-scell">
    ...
    ?>
        ...
        <div class="uni-our-team-wrap">
            <div class="wrapper">
                ...
                ?>
                    <?php
                    $is_desc = ( isset( $oUser->description ) && ! empty( $oUser->description ) ) ? true : false;
                    echo isset( $is_desc ); ?>
                    <div class="uni-our-team-item<?php echo esc_attr( ( $is_desc ) ? ' uni-with-desc' : '' ); ?>">
