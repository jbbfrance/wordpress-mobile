...
class Builder {
	...
	public function settings_content( $instance ) {
		...
		echo '<a href="' . \esc_url( \home_url( $instance->form->post_name ) ) . '" id="wpforms-form-pages-preview-form-page" target="_blank">' . esc_html__( 'Preview Form Page', 'wpforms-lite' ) . '</a>';
